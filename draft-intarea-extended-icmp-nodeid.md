...
docname: draft-intarea-extended-icmp-nodeid-latest
submissiontype: IETF
number:
date:
consensus: true
...
venue:
  ...
  latest: "https://fenner.github.io/icmp-node-id/draft-intarea-extended-icmp-nodeid.html"
